					...
					<td>
						<fieldset>
							<label for="mscr_product_id">
								<input type="text" value="<?php echo esc_attr( $product_id ); ?>" id="mscr_product_id" name="mscr_options[product_id]"  />
					...
					<td>
						<fieldset>
							<label for="mscr_api_token">
								<input type="text" value="<?php echo esc_attr( $api_token ); ?>" id="mscr_product_id" name="mscr_options[api_token]"  />
